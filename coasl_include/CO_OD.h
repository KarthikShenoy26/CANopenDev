...
/*
 * Example:
 * CO_NO_SYNC : Canopen Number of sync objects : 0 means no objects used, 1 means one object is being used.
 */
 ...
 * These are the definition of complex data types (Records) in CANopen.
 * Objects are mainly of simple data types, array, record, domain types
 * Below are the record types.
 *
*******************************************************************************/
/*1018      */ typedef struct{
...
/*1600[4]   */ typedef struct{
               ...
               //these for 4 RPDO:  32*2=64,   These are 4 64 or 8 32 giving 4RPDO
...
/*1A00[4]   */ typedef struct{
               UNSIGNED8      numberOfMappedObjects;
               //these for 4 TPDO:  32*2=64,   These are 4 64 or 8 32 giving 4TPDO
               UNSIGNED32     mappedObject1;
               UNSIGNED32     mappedObject2;
               UNSIGNED32     mappedObject3;
               UNSIGNED32     mappedObject4;
...
//Below 6XXX look like application specific
...
/*******************************************************************************
    ...
    * Look into the default setting here. Before we start using this
*******************************************************************************/
